...
public static class Tests
{
    ...
    private static void TestKingsPosition()
    {
        var board = new San.Board();
        board.PutPiece(new San.Position("e1"), new San.Piece('w', 'k'));
        board.PutPiece(new San.Position("e8"), new San.Piece('b', 'k'));
        var fen = board.ToFen(true);
        if (!"4k3/8/8/8/8/8/8/4K3 w - - 0 1".Equals(fen)) {
            throw new Exception();
        }
    }
    ...
    private static void TestOneMove()
    {
        var board = new San.Board();
        board.StartGame();
        if (!board.Move("e4")) {
        ...
        var fen = board.ToFen();
        if (!"rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1".Equals(fen)) {
            throw new Exception();
        }
    }
    ...
    {
        var pars = pgn.Split(' ', StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries);
    ...
    private static void TestGame1()
    {
        var pgn = @"1. e4 e5 2. Nf3 Nf6 3. Nxe5 Nc6 4. d4 Nxe5 5. dxe5 Nxe4 6. Qe2 Ng5 7. f4 Ne6 8.
    Nc3 Bc5 9. Bd2 Nd4 10. Qe4 Qh4+ 11. g3 Qg4 12. Be2 Nxe2 13. Nxe2 Qe6 14. f5 Qb6
    15. Rf1 Qxb2 16. Bc3 Qb6 17. Qh4 Qc6 18. e6 dxe6 19. Bxg7 Rg8 20. Qxh7 Rxg7 21.
    Qxg7 Bb4+ 22. c3 Bf8 23. Qg5 exf5";
        ...
        var fen = board.ToFen();
        if (!"r1b1kb2/ppp2p2/2q5/5pQ1/8/2P3P1/P3N2P/R3KR2 w Qq - 0 24".Equals(fen)) {
            throw new Exception();
        }
    }

    private static void TestGame2()
    {
        var pgn = @"1. e4 c6 2. d4 d5 3. exd5 cxd5 4. Nc3 Nf6 5. Bb5+ Nc6 6. Bg5 Qa5 7. Bxf6 exf6 8. Qe2+ Be6 9. O-O-O Bd6 10. g3 Rc8 11. f4 O-O 12. Nf3 Rc7 13. Nh4 h5 14. f5 Nb4 15. a3 Bxf5 16. Nxf5 Rxc3 17. Nxd6 Rxc2+ 18. Qxc2 Nxc2 19. Kxc2 g5 20. a4 a6 21. Nxb7 Qb6 22. Nc5 axb5 23. Kb1 Qb8 24. Nd7 Qd6 25. Nxf8 bxa4 26. Rd3 Kxf8 27. Ra3 Qd8 28. Rxa4 Kg7 29. Ra3 Qe7 30. Ka2 g4 31. h4 Qe2 32. Rc1 f5 33. Rc5 Kf6 34. Rxd5 Qe3 35. Rxe3";
        var moves = GetMoves(pgn);
        var board = new San.Board();
        board.StartGame();
        for (var i = 0; i < moves.Length; i++) {
        ...
        var fen = board.ToFen();
        if (!"8/5p2/5k2/3R1p1p/3P2pP/4R1P1/KP6/8 b - - 0 35".Equals(fen)) {
            throw new Exception();
        }
    }
    ...
    {
        var pgn = @"1. e4 c5 2. Nf3 e6 3. d4 cxd4 4. Nxd4 Nc6 5. Be3 Nf6 6. f3 e5 7. Nb3 b6 8. h4 Be7 9. Nc3 Bb7 " + 
        ...
        var fen = board.ToFen();
        if (!"8/8/4K3/4N3/5k2/8/4q3/8 w - - 16 73".Equals(fen)) {
            throw new Exception();
        }
    }

    private static void TestGame4()
    {
        var pgn = "1. e4 e5 2. Nf3 Nf6 3. Nc3 Bc5 4. Bd3 d6 5. Nd5 Nxd5 6. exd5 O-O 7. O-O f5 8. Be2 e4 9. Ne1 f4 " +
        ...
        var fen = board.ToFen();
        if (!"5k2/6p1/6Pp/pb5P/8/2p1p2r/p1P5/RR2K1r1 w - - 2 72".Equals(fen)) {
            throw new Exception();
        }
    }
}
